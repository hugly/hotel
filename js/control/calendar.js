...
calendar.prototype={
    ...
    createCalendarTitle:function(data){
        var oHead=$('<div class="operations"></div>'),
        ...
        oRemote.append(oPre).append(oTheday).append(oNext);
        this.oParent.append(oWeeks);
        this.oParent.append(oRemote);
            ...
            if(this.iNowTime==0 && i<nowDay){
                ...
                if(data && hasPriceArr.indexOf(i)!=-1){
                    if(i==nowDay && this.iNowTime==0){
                        ...
                        if(data[num].LeftAmount>this.ticketNum){
                            oCalendar.append($('<div class="nowDay hasEvent" data="'+data[num].StartTime+'" ticket="'+data[num].LeftAmount+'" price="'+data[num].Price+'"><span class="asap">'+i+'</span><span class="price">￥'+data[num].Price+'</span></div>'));
                        }else{
                            oCalendar.append($('<div class="nowDay hasEvent" data="'+data[num].StartTime+'" ticket="'+data[num].LeftAmount+'" price="'+data[num].Price+'"><span class="asap">'+i+'</span><span class="ticket">余'+data[num].LeftAmount+'</span><span class="price">￥'+data[num].Price+'</span></div>'));
                        }
                    }
                    num++;
                }else{
